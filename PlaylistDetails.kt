...
import com.Capstone.musicPlayer.databinding.ActivityPlaylistDetailsBinding
...
class PlaylistDetails : AppCompatActivity() {
    ...
    override fun onResume() {
        ...
        {
            Glide.with(this)
                .load(PlaylistActivity.musicPlaylist.ref[currentPlaylistPos].playlist[0].artist!!.picture)

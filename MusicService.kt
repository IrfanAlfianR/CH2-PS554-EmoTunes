...
class MusicService: Service(), AudioManager.OnAudioFocusChangeListener {
    ...
    fun showNotification(playPauseBtn: Int){
        ...
        val imgArt = getImgArt(PlayerActivity.musicListPA[PlayerActivity.songPosition].preview!!)
        ...
        val notification = androidx.core.app.NotificationCompat.Builder(baseContext, ApplicationClass.CHANNEL_ID)
            ...
            .setContentText(PlayerActivity.musicListPA[PlayerActivity.songPosition].artist.toString())
    ...
    fun createMediaPlayer(){
        try {
            ...
            mediaPlayer!!.reset()
            mediaPlayer!!.setDataSource(PlayerActivity.musicListPA[PlayerActivity.songPosition].preview)
            mediaPlayer!!.prepare()
            PlayerActivity.binding.playPauseBtnPA.setIconResource(R.drawable.pause_icon)
            showNotification(R.drawable.pause_icon)

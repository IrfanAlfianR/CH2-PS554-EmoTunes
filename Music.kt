...
class Playlist{
    ...
    lateinit var playlist: ArrayList<DataItem>
...
class MusicPlaylist{
 ...
 private fun TimeUnit.convert(duration: Int?, milliseconds: TimeUnit): Long {
     if (duration == null) {
         return 0
     }

     return milliseconds.convert(duration.toLong(), this)
 }
...
fun checkPlaylist(playlist: ArrayList<DataItem>): ArrayList<DataItem>{
    playlist.forEachIndexed { index, music ->
        val file = File(music.preview)
        if(!file.exists())

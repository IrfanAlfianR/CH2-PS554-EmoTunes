...
class NotificationReceiver:BroadcastReceiver() {
    ...
    private fun prevNextSong(increment: Boolean, context: Context){
        ...
        Glide.with(context)
            .load(PlayerActivity.musicListPA[PlayerActivity.songPosition].artist!!.picture)
        ...
        playMusic()
        PlayerActivity.fIndex = favouriteChecker(PlayerActivity.musicListPA[PlayerActivity.songPosition].id.toString())

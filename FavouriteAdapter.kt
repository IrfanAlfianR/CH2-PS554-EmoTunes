...
import com.Capstone.musicPlayer.databinding.FavouriteViewBinding
import com.Capstone.musicPlayer.databinding.MoreFeaturesBinding

class FavouriteAdapter(private val context: Context, private var musicList: ArrayList<DataItem>,val playNext: Boolean = false) : RecyclerView.Adapter<FavouriteAdapter.MyHolder>() {
    ...
    fun updateFavourites(newList: ArrayList<DataItem>){
        musicList = ArrayList()
